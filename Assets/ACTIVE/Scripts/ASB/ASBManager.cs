    ...
    */
    ...
    private void OnASBGameStateChanged()
    {
        ...
        if (GameState == ASBStateGame.Intro || GameState == ASBStateGame.NewRound)
        {
            ...
            //targetSpeed = 2;//TODO adjust the speed value of stimuli
            //if (ASBPlayer.LocalPlayer != null) 
            //{
            //    targetSpeed = ASBPlayer.LocalPlayer.GetComponent<MoveOnPathScript>().PlayerSpeed - 1;
            //    Debug.Log("target speed is based on player speed and equal to " + targetSpeed);
            //}
